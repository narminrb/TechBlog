...
const Footer = () => {
  return (
    ...
    <div class="flex flex-col min-[520px]:flex-row items-center  gap-6 pb-6 border-b-2 border-gray-200">
        <span class="text-[18px] font-bold text-black">Follow Us</span>
        <div class="flex items-center gap-4">
          <Link to="javascript:;" style={{backgroundColor:'#f0f2f5'}}
            class="p-2 rounded-full aspect-square text-gray-700 transition-all duration-500 hover:text-indigo-600 hover:border-indigo-600 focus-within:outline-0 focus-within:text-indigo-600 focus-within:border-indigo-600">
      ...
      <div class="flex flex-col min-[830px]:flex-row items-center justify-between  gap-6 pt-4">
      <div className='flex flex-row gap-10'> 
         <Link to="https://pagedone.io/" class="py-1.5">
          <div className='relative w-[150px] h-[40px] overflow-hidden'>
           <img className='w-full h-full object-cover' src="https://new.axilthemes.com/demo/react/blogar/images/logo/logo-black.webp?imwidth=256" alt="" />g
          </div>
        </Link>
        <ul class="flex flex-col sm:flex-row items-center gap-5 sm:gap-12">
          <li><Link to="jaascript:;" style={{color:'#878787'}}
              class="text-[17px] font-medium transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Pagedone</Link>
          </li>
          <li><Link to="jaascript:;" style={{color:'#878787'}}
              class="text-[17px]  font-medium transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Products</Link>
          </li>
          <li><Link to="jaascript:;" style={{color:'#878787'}}
              class="text-[17px]  font-medium transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Resources</Link>
          </li>
          <li><Link to="jaascript:;" style={{color:'#878787'}}
              class="text-[17px]  font-medium transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Blogs</Link>
          </li>
          <li><Link to="jaascript:;" style={{color:'#878787'}}
              class="text-[17px]  font-medium transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Support</Link>
          </li>
        </ul></div>
      <div class="flex flex-col min-[200px]:flex-row items-center gap-6 pt-4">
      <span class="text-sm font-normal text-gray-500">All Rights Reserved ©<a href="https://pagedone.io/"> 2025</a> </span>
        </div>
      </div>
